...
syms t;
N=50;   % mam here value of N is very large so the output will take  some time to appear but for smaller values like 5 or 10 output appear easily
n=1:N;
...
plot(k,F)
title('square wave output using  fourier series');
xlabel('t');
ylabel('amplitude');
grid on;
